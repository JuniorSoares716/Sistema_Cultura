...
@section('content')
		...
		<div class="container-fluid">
			<form class="form-horizontal" action="{{route('pessoa.update',['pessoa' => $pessoa->id, 'curso' => $curso])}}" method="POST">
				{{ csrf_field() }}
				<fieldset class="col-md-6">
					<div class="panel panel-primary">
						<div class="panel-heading text-center">ATUALIZAR INFORMAÇÕES DE MATRÍCULA</div>
						<div class="panel-body">
							...
							<div class="form-group col-md-8 {{ $errors->has('nome') ? ' has-error' : '' }}">
								...
								<div class="col-md-10">
									<input id="nome" name="nome" value="{{ $pessoa->nome }}" class="form-control input-md" type="text">
								</div>
							...
							<div class="form-group col-md-4 {{ $errors->has('idade') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									<input id="idade" name="idade" maxlength="3" value="{{ $pessoa->idade }}" class="form-control input-md" type="text">
								</div>
							...
							<div class="form-group col-md-8 {{ $errors->has('rua') ? ' has-error' : '' }}">
								...
								<div class="col-md-10">
									<input id="rua" name="rua" value="{{$pessoa->rua }}" class="form-control input-md" type="text">
								</div>
							...
							<div class="form-group col-md-4 {{ $errors->has('numero') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									<input id="numero" maxlength="6" name="numero" value="{{ $pessoa->numero }}" class="form-control input-md" type="text">
								</div>
							...
							<div class="form-group col-md-6 {{ $errors->has('complemento') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									<input id="complemento" name="complemento" value="{{ $pessoa->complemento }}" class="form-control input-md" type="text">
								</div>
							...
							<div class="form-group col-md-6 {{ $errors->has('bairro') ? ' has-error' : '' }}">
								...
								<div class="col-md-8">
									<input id="bairro" name="bairro" value="{{ $pessoa->bairro }}" class="form-control input-md" type="text">
								</div>
							...
							<div class="form-group col-md-6 {{ $errors->has('email') ? ' has-error' : '' }}">
								...
								<div class="col-md-9">
									<input id="email" name="email" placeholder="cedro@secretaria.com" class="form-control input-md" value ="{{ $pessoa->email }}" type="email">
								</div>
							...
							<div class="form-group col-md-6 {{ $errors->has('celular') ? ' has-error' : '' }}">
								...
								<div class="col-md-9">
									<input id="celular" name="celular" value ="{{ $pessoa->celular }}" placeholder="(00) 9 0000-0000" maxlength="16" class="form-control input-md" type="text">
								</div>
                        	...
                        	<div class="form-group col-md-6 {{ $errors->has('telefone') ? ' has-error' : '' }}">
								...
								<div class="col-md-9">
									<input id="telefone" name="telefone" placeholder="(00) 0000-0000" class="form-control input-md" value ="{{ $pessoa->telefone }}" type="text" maxlength="14">
								</div>
                        	...
                        	<div class="form-group col-md-6 {{ $errors->has('outro') ? ' has-error' : '' }}">
								...
								<div class="col-md-9">
									<input id="outro" name="outro" placeholder="(00) 0000-0000" class="form-control input-md" value ="{{$pessoa->outro }}" type="text" maxlength="14">
								</div>
							...
							<div class="form-group">
								...
								<div class="form-group col-md-8 {{ $errors->has('instituicao') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="instituicao" name="instituicao" value ="{{ $pessoa->instituicao }}" class="form-control input-md" type="text">
									</div>
								...
								<div class="form-group col-md-4 {{ $errors->has('ano') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="ano" name="ano" value ="{{ $pessoa->ano }}" placeholder="1" class="form-control input-md" type="text">
									</div>
								...
								<div class="form-group col-md-8 {{ $errors->has('turno') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<select class="form-control" name="turno">
											@if($pessoa->turno =="M")
											<option value="{{$pessoa->turno}}"> Manhã </option>
											@elseif($pessoa->turno =="T")
												<option value="{{$pessoa->turno}}"> Tarde </option>
											@elseif($pessoa->turno =="N")
												<option value="{{$pessoa->turno}}"> Noite </option>
											@else
							...
							<div class="col-md-12">
								<div class="form-group text-center">
									<div>
										<button type="submit" class="col-md-5 btn btn-success pull-left">Alterar</button>
